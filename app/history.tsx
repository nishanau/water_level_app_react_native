...
export default function HistoryScreen() {
  ...
  const [activeTab, setActiveTab] = useState<'chart' | 'notifications'>('chart');
    ...
    <SafeAreaView style={styles.container}>
      ...
      {activeTab === 'chart' ? (
        <View style={styles.chartContainer}>
          <Text style={styles.chartTitle}>Water Level History</Text>
          <ScrollView>
          ...
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValue}>
                {Math.round(
                  historyData.reduce((sum: number, item: HistoryDataItem) => sum + item.level, 0) / historyData.length
                )}%
              </Text>
            </View>
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValue}>
                {Math.min(...historyData.map((item: HistoryDataItem) => item.level))}%
              </Text>
            </View>
          </View>
        </View>
